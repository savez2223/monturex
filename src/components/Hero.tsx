        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center py-20 lg:py-32">
          <div className="space-y-8 text-center lg:text-left">
            ...
            <p className="text-lg md:text-xl text-primary-foreground/80 max-w-2xl mx-auto lg:mx-0">
              Browser, Email, Network & Firewall protection — lightweight, easy
              to install.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Button
                size="lg"
                className="bg-accent text-accent-foreground border border-accent/20 hover:-translate-y-1 transition-all duration-300 hover:bg-accent/90 shadow-lg hover:shadow-xl"
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-primary-foreground/20 text-primary-foreground bg-primary-foreground/10 hover:-translate-y-1 transition-all duration-300 hover:bg-primary-foreground/20"
                onClick={scrollToFeatures}
              >
                Learn More
